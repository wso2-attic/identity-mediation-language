 ...
 */
@Component(
        name = "AuthenticationResponseProcessorProvider",
        immediate = true,
        service = MediatorProvider.class
)
public class AuthenticationResponseProcessorProvider implements MediatorProvider {
    ...
    protected void register(AuthenticationContext authenticationContext, Map<String, String> properties) {
        AuthenticationResponseProcessorDataHolder.getInstance().setAuthenticationContextMap(authenticationContext);
    }
