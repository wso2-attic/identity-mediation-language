...
package org.wso2.carbon.identity.gateway.inbound.dispatcher.meditors.common.callback.mediators.authentication.request.builder;
 ...
 */
@Component(
        name = "AuthenticationRequestBuilderProvider",
        immediate = true,
        service = MediatorProvider.class
)
public class AuthenticationRequestBuilderProvider implements MediatorProvider {
    ...
    protected void register(AuthenticationContext authenticationContext, Map<String, String> properties) {
        AuthenticationRequestBuilderDataHolder.getInstance().setAuthenticationContextMap(authenticationContext);
    }
