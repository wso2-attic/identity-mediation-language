...
package org.wso2.carbon.identity.gateway.inbound.dispatcher.mediators.oidc.response.processor;
 ...
 */
@Component(
        name = "OIDCResponseProcessorProvider",
        immediate = true,
        service = MediatorProvider.class
)
public class OIDCResponseProcessorProvider implements MediatorProvider {
    ...
    protected void register(AuthenticationContext authenticationContext, Map<String, String> properties) {
        OIDCResponseProcessorDataHolder.getInstance().setAuthenticationContextMap(authenticationContext);
    }
    ...
    public Mediator getMediator() {
        return new OIDCResponseProcessor();
    }
