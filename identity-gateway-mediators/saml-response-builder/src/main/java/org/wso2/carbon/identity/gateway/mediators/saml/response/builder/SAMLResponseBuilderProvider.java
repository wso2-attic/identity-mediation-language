 ...
 */
@Component(
        name = "SAMLResponseBuilderProvider",
        immediate = true,
        service = MediatorProvider.class
)
public class SAMLResponseBuilderProvider implements MediatorProvider {
    ...
    protected void register(AuthenticationContext authenticationContext, Map<String, String> properties) {
        SAMLResponseBuilderDataHolder.getInstance().setAuthenticationContextMap(authenticationContext);
    }
